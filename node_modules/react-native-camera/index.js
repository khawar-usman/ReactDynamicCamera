...
function convertNativeProps(props) {
  ...
  if (typeof props.videoWidthForCrop === 'string') {
    newProps.captureMode = Camera.constants.videoWidthForCrop[props.videoWidthForCrop];
  }

  if (typeof props.videoHeightForCrop === 'string') {
    newProps.captureMode = Camera.constants.videoHeightForCrop[props.videoHeightForCrop];
  }
...
export default class Camera extends Component {
  ...
  static constants = {
    ...
    videoWidthForCrop: CameraManager.videoWidthForCrop,
    videoHeightForCrop: CameraManager.videoHeightForCrop
  };
  ...
  static propTypes = {
    ...
    videoWidthForCrop: PropTypes.number,
    videoHeightForCrop: PropTypes.number
  };
