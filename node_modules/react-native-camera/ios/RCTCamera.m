...
-(void)setVideoWidthForCrop:(NSInteger)width{
    self.manager.videoWidthForCrop = width;
}

-(void)setVideoHeightForCrop:(NSInteger)height{
    self.manager.videoHeightForCrop = height;
